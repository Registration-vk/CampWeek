...
// export const adminPanelEventsSlice = createSlice({
//   name: "events",
...
// export const { actions: eventsActions } = adminPanelEventsSlice;
// export const { reducer: eventsReducer } = adminPanelEventsSlice;
